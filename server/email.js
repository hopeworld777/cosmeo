  ...
  await sendEmail({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;background:#faf9ff;border-radius:24px;padding:32px;">
        ...
        <p style="color:#374151;line-height:1.6;">Thanks for signing up! Click the button below to verify your email address and unlock full access to Kosmeo.</p>
        ...
        <p style="color:#d1d5db;font-size:12px;margin-top:24px;">© Kosmeo • Where cosplay culture shops</p>
      </div>`,
  });
  return link;
}
...
export async function sendPasswordResetEmail(to, token) {
  ...
  await sendEmail({
    to,
    subject: "Reset your Kosmeo password",
